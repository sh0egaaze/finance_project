import {
  ...
  AlertTriangle, Lightbulb, Settings, DollarSign, Shield, X
} from 'lucide-react';
...
export default function Sidebar({ activeTab, onTabChange, user, isOpen = true, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      `}>
        {/* Логотип */}
        <div className="px-5 py-[13px] border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
